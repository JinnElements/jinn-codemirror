...
// src/parser/leiden+/parser.terms.js
var chars = 30;
var lostLinesStart = 31;
var Unclear = 1;

// src/parser/tokens.ts
var skipped = "() <>?=.0123456789[]\u301A\u301B";
var charsToken = new ExternalTokenizer((input) => {
  let str = "";
  for (; ; ) {
    if (input.next < 0) {
      break;
...
var unclearToken = new ExternalTokenizer((input) => {
  let charCount = 0;
  for (; ; ) {
...
// src/import/leiden+2xml.ts
var blockElements = ["Recto", "Verso", "Fragment", "Part", "Div"];
function leidenPlus2epiDoc(input, root = parser.parse(input)) {
  function text(node) {
...
//# sourceMappingURL=leiden+2xml.js.map
